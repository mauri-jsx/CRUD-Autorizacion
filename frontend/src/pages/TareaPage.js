...
import { getTareas, createTarea, deleteTarea, updateTarea } from '../api/tarea.js';
    ...
    <div class="min-h-screen bg-gray-100 flex flex-col justify-center items-center">
      ...
      <div class="w-full max-w-3xl p-8 bg-white shadow-md rounded-lg mt-6">
        ...
        <form id="tareaForm" class="mb-6">
          ...
          <textarea id="descripcion" placeholder="Descripción" class="border p-2 mb-4 w-full" required></textarea>
    ...
    document.querySelectorAll('.edit').forEach(button => {
      button.addEventListener('click', async (e) => {
        ...
        const { value: formValues } = await Swal.fire({
          title: 'Editar Tarea',
          html:
            `<input id="swal-input1" class="swal2-input" placeholder="Título" value="${tarea.titulo}">` +
